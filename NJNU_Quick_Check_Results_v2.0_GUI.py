...
class MyFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.text_ctrl_1 = wx.TextCtrl(self.panel, wx.ID_ANY,style=wx.TE_PROCESS_ENTER)
        ...
        self.text_ctrl_3 = wx.TextCtrl(self.panel, wx.ID_ANY,style=wx.TE_PROCESS_ENTER)
        ...
        self.list_ctrl_1 = wx.ListCtrl(self.panel, wx.ID_ANY,style=wx.LC_REPORT)
